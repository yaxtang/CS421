...
tests = [
     ...
     --   , testGroup "Calls to getFollowSet" [
     --       testOne "get first set test ll1" (testGetFollow g_ll1 fls_ll1)
     --      ,testOne "get first set test ll2" (testGetFollow g_ll2 fls_ll2)
     --      ,testOne "get first set test ll3" (testGetFollow g_ll3 fls_ll3)
     --      ,testOne "get first set test rec1" (testGetFollow g_rec1 fls_rec1)
     --      ,testOne "get first set test rec2" (testGetFollow g_rec2 fls_rec2)
     --      ,testOne "get first set test rec3" (testGetFollow g_rec3 fls_rec3)
     --      ,testOne "get first set test rec4" (testGetFollow g_rec4 fls_rec4)
     --      ,testOne "get first set test cp1" (testGetFollow g_cp1 fls_cp1)
     --      ,testOne "get first set test cp2" (testGetFollow g_cp2 fls_cp2)
     --      ,testOne "get first set test cp3" (testGetFollow g_cp3 fls_cp3)
     --      ,testOne "get first set test cp4" (testGetFollow g_cp4 fls_cp4)
     --      ]
