...
-- getFollowSet grammar
-- calculate the follow sets of the nonterminals in a grammar
getFollowSet :: Grammar -> H.HashMap Symbol (S.HashSet Symbol)
getFollowSet = undefined
